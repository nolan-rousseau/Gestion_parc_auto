...
public class Edit_EmployeeController implements Initializable {
    ...
    @FXML
    private void UpdatEmployee(ActionEvent event) {
        try {
            Employee employee = employeeToEdit;
            ...
            ClearValues();
            ihmWindowBox.showInformation("L'employé à été modifié avec succès.");
            LoadAll();
            UpdateControlsWithEmployee(employee);
        } catch (Exception e){
    ...
    protected void UpdateControlsWithEmployee(Employee employee) {
